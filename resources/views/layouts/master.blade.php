        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        @can('hasPermission','view_parcel_tracking_dashboard')
                            <li class="nav-item">
                                <a href="{{ route('logistics.customers.index') }}" class="nav-link active">
                        ...
                        @can('hasPermission','view_parcel_tracking_dashboard')
                            <li class="nav-item">
                               <a href="{{ route('logistics.receivers.index') }}" class="nav-link active">
                                    <i class="fas fa-tachometer-alt"></i>Receiver
                                </a>
                            </li>
                        @endcan
                        @can('hasPermission','view_parcel_tracking_dashboard')
                            <li class="nav-item">
                               <a href="{{ route('logistics.parcels.index') }}" class="nav-link active">
                                    <i class="fas fa-tachometer-alt"></i>Parcels
                                </a>
                        ...
                        @can('hasPermission','view_parcel_tracking_dashboard')
                        <li class="nav-item">
                            <a href="{{ route('logistics.tracking-updates.index') }}" class="nav-link active">
                                <i class="fas fa-tachometer-alt"></i>Tracking Updates
                            </a>    
                        </li>
                    @endcan
                ...
                @can('hasPermission','view_parcel_tracking_dashboard')
                    <li class="nav-item">
                        <a href="{{ route('logistics.parcel-histories.index') }}" class="nav-link active">
                          <i class="fas fa-tachometer-alt"></i>Parcel Histories
                        </a>
                    </li>
                @endcan
                        ...
                        @can('hasPermission', 'view_clients')
                            <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.subscriptions.index') }}" class="nav-link active">
                                <i class="fas fa-tachometer-alt"></i>
                                <p>
                                    Subscriptions
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.quotations.index') }}" class="nav-link active">
                                <i class="fas fa-tachometer-alt"></i>
                                <p>
                                    Quotations
                                </p>
