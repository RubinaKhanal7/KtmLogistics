...
<div class="card card-primary">
    ...
    <form id="quickForm" novalidate="novalidate" method="POST" action="{{ route('admin.images.update') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="id" value="{{ $image->id }}">
        <div class="card-body">
            <div class="form-group">
                <label for="title">Title</label><span style="color:red; font-size:large"> *</span>
                <input style="width:auto;" type="text" value="{{ $image->title ?? '' }}" name="title" class="form-control" id="title" placeholder="Title">
            </div>
            <div class="form-group">
            ...
            <img src="{{ url('storage/'.$image->image) ?? '' }}" id="preview" style="max-width: 500px; max-height:500px" />
